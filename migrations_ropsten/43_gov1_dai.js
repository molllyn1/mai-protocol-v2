...
module.exports = async function (deployer, network, accounts) {
    ...
    await perpetual.setGovernanceParameter(toBytes32("tradingLotSize"), toWad(0.01)); // 1 dollar
    await perpetual.setGovernanceParameter(toBytes32("lotSize"), toWad(0.01)); // 1 dollar
